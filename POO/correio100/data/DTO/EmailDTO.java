...
public class EmailDTO {
    ...
    public static Email fromJson(Map<String, Object> email) {
        ...
        String message = FunctionsUtil.decriptar(date.getDayOfMonth(), email.get("message").toString());
    ...
    public static Map<String, Object> toJson(Email email) {
        ...
        emailMap.put("message", FunctionsUtil.encriptar(email.getDate().getDayOfMonth(), email.getMessage()));
        emailMap.put("subject", email.getSubject());
        emailMap.put("id", email.getId());
        emailMap.put("date", email.getDate());
