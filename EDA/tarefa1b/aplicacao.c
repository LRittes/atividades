#include "arq.h"
#include "filaDupEncPrioridade.c"
#include "math.h"
#include <stdio.h>
...
int main(void)
{
    ...
    buscaNaFrente(&tmp, p);
    printf("frente da fila %i %s \n\n", tmp.idade, tmp.nome);
    buscaNoRefMovel(&tmp, p);
    printf("Referencial movel da fila %i %s \n\n", tmp.idade, tmp.nome);
